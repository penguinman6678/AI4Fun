...
def select_games_winning(a_list_of_dict):
    sub_set = []
    for each_game_log in a_list_of_dict:
        if each_game_log.get('player_winner') == "O":
...
if __name__ == "__main__":
    ...
    #sub_set_by_O = select_games_winning(list_of_dict_for_games)
    #print_sequence_for_a_game(sub_set_by_O[1])
